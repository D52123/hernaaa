...
{  
    ...
    public static List<Vector3> PlotTrajectory(UseableGun gun, out RaycastHit hit, int maxSteps = 255)
    {
        ...
        float num = 0.1f; // Default ballistic drop value
        // ballisticDrop property moved to ItemCaliberAsset.BallisticGravityMultiplier
        ...
        if (flag)
        {
            // barrelAsset.ballisticDrop also moved, using default value
            num *= 0.1f;
        }
