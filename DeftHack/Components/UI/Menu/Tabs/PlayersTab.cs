...
{ 
    ...
    public static void Tab()
    {
        ...
        Prefab.MenuArea(new Rect(0f, 260f, 190f, 175f), "ОПЦИИ", delegate
        {
            ...
            if (!flag)
            {
                // CSteamID steamID = PlayersTab.SelectedPlayer.channel.owner.playerID.steamID; // Missing CSteamID reference
                GUILayout.BeginHorizontal(new GUILayoutOption[0]);
        ...
        Prefab.MenuArea(new Rect(196f, 260f, 270f, 175f), "Информация", delegate
        {
            ...
            if (!flag)
            {
                ...
                // GUILayout.TextField(PlayersTab.SelectedPlayer.channel.owner.playerID.steamID.ToString(), Prefab._TextStyle, new GUILayoutOption[0]); // Missing CSteamID reference
                GUILayout.Space(2f);
