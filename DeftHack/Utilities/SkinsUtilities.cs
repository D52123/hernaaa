...
public static class SkinsUtilities
{
    ...
    public static HumanClothes CharacterClothes { get { return OptimizationVariables.MainPlayer.clothing.characterClothes; } }
     
    public static HumanClothes FirstClothes { get { return OptimizationVariables.MainPlayer.clothing.firstClothes; } }
     
    public static HumanClothes ThirdClothes { get { return OptimizationVariables.MainPlayer.clothing.thirdClothes; } }
    ...
    public static void Apply(Skin skin, SkinType skinType)
    {
        ...
        if (flag)
        {
            ...
            if (!flag2)
            {
                /* TempSteamworksEconomy.getInventoryItemID doesn't exist in new Unturned API
                   Commenting out skin functionality for now
    ...
    {
        // DEPRECATED: UnturnedEconInfo.type property no longer exists in modern Unturned
        // This feature has been disabled for compatibility with current Unturned version
        // TODO: Update to use new economy API when available
