...
public class OV_PlayerInput
{
    ...
    public static void OV_askAck(PlayerInput instance, CSteamID steamId, int ack)
    {
        ...
        if (!flag)
        {
            ...
            {
                // sequence property removed from PlayerInputPacket API
    ...
    public static void OV_InitializePlayer(PlayerInput instance)
    {
        ...
        bool flag = instance.player != localPlayer;
        if (flag)
        {
        ...
        {
            // Note: OptimizationVariables.MainPlayer now uses the compatibility layer automatically
