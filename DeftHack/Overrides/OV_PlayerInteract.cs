...
public class OV_PlayerInteract
{
    ...
    public float salvageTime
    {
        get
        {
            ...
            if (OptimizationVariables.MainPlayer?.channel?.owner == null || !OptimizationVariables.MainPlayer.channel.owner.isAdmin)
            {
                return 8f;
            }
            return 1f;
    ...
    public static void OnSpied()
    {
            ...
            if (transform != null && OptimizationVariables.MainPlayer?.look != null)
            {
    ...
    public void OV_Update()
    {
        ...
        if (OptimizationVariables.MainPlayer?.stance == null || OptimizationVariables.MainPlayer?.life == null || OptimizationVariables.MainPlayer?.workzone == null)
        {
            return;
        }
        if (OptimizationVariables.MainPlayer.stance.stance != EPlayerStance.DRIVING && OptimizationVariables.MainPlayer.stance.stance != EPlayerStance.SITTING && !OptimizationVariables.MainPlayer.life.isDead && !OptimizationVariables.MainPlayer.workzone.isBuilding)
        {
            if (Time.realtimeSinceStartup - OV_PlayerInteract.lastInteract > 0.1f)
            {
                ...
                if (Camera.main != null && OptimizationVariables.MainPlayer?.look != null)
                {
            ...
            if (transform != OV_PlayerInteract.focus)
            {
                ...
                {
                    // DEPRECATED: InteractableDoorHinge class no longer exists in modern Unturned
                    /* COMMENTED OUT - DEPRECATED API
        ...
        if (OptimizationVariables.MainPlayer?.life == null || OptimizationVariables.MainPlayer.life.isDead)
        {
            return;
        }
        if (PlayerInteract.interactable != null)
        ...
        else if (OV_PlayerInteract.focus != null && OV_PlayerInteract.focus.CompareTag("Enemy"))
        {
            ...
            if (player != null && player != localPlayer && !PlayerUI.window.showCursor)
            {
        ...
        if (OptimizationVariables.MainPlayer?.stance != null && (OptimizationVariables.MainPlayer.stance.stance == EPlayerStance.DRIVING || OptimizationVariables.MainPlayer.stance.stance == EPlayerStance.SITTING) && !Input.GetKey(KeyCode.LeftShift))
        {
        ...
        if (Input.GetKeyDown(ControlsSettings.inspect) && ControlsSettings.inspect != ControlsSettings.interact && OptimizationVariables.MainPlayer?.equipment != null && OptimizationVariables.MainPlayer.equipment.canInspect)
        {
            if (OptimizationVariables.MainPlayer?.channel != null)
            {
        ...
        if (OV_PlayerInteract.isHoldingKey)
        {
            if (Input.GetKeyUp(ControlsSettings.interact))
            {
                ...
                {
                    if (OptimizationVariables.MainPlayer?.inventory != null && OptimizationVariables.MainPlayer.inventory.isStoring && OptimizationVariables.MainPlayer.inventory.shouldInteractCloseStorage)
                    {
                    ...
                    // DEPRECATED: PlayerBarricadeStereoUI
                    /*
                    ...
                    */
                    ...
                    // DEPRECATED: UI APIs changed from static to instance in modern Unturned
                    /* COMMENTED OUT - DEPRECATED API
                ...
                {
                    if (OptimizationVariables.MainPlayer?.stance != null && (OptimizationVariables.MainPlayer.stance.stance == EPlayerStance.DRIVING || OptimizationVariables.MainPlayer.stance.stance == EPlayerStance.SITTING))
                    {
                    ...
                    {
                        if (OptimizationVariables.MainPlayer?.skills != null && OptimizationVariables.MainPlayer?.movement?.purchaseNode != null && OptimizationVariables.MainPlayer.skills.experience >= OptimizationVariables.MainPlayer.movement.purchaseNode.cost)
                        {
                            OptimizationVariables.MainPlayer.skills.sendPurchase(OptimizationVariables.MainPlayer.movement.purchaseNode);
                            return;
                        }
                    }
                    else if (ControlsSettings.inspect == ControlsSettings.interact && OptimizationVariables.MainPlayer?.equipment != null && OptimizationVariables.MainPlayer.equipment.canInspect)
                    {
                        if (OptimizationVariables.MainPlayer?.channel != null)
                        {
                            OptimizationVariables.MainPlayer.channel.send("askInspect", ESteamCall.SERVER, ESteamPacket.UPDATE_UNRELIABLE_BUFFER, new object[0]);
