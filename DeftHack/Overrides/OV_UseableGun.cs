...
public class OV_UseableGun
{
    ...
    public void OV_ballistics()
    {
        ...
        {
            if (OptimizationVariables.MainPlayer.equipment.asset == null || OptimizationVariables.MainPlayer.look == null)
            {
                return;
            }
                ...
                if (!flag3)
                {
                    ...
                    if (ballistics)
                    {
                        ...
                        if (flag4)
                        {
                            ...
                            // NoDrop feature disabled - BulletInfo API changed in new Unturned
                            /*
                            ...
                            if (flag7)
                            {
                                for (int i = 0; i < list.Count; i++)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (OptimizationVariables.MainPlayer?.input != null)
                                        {
                        ...
                        for (int k = 0; k < list.Count; k++)
                        {
                            ...
                            if (OptimizationVariables.MainPlayer?.transform == null) return;
                            ...
                            if (!flag11)
                            {
                                ...
                                // PlayerUI.hitmark signature changed in new Unturned - commenting out
                    ...
                    else
                    {
                        ...
                        if (flag13)
                        {
                            for (int m = 0; m < list.Count; m++)
                            {
                                ...
                                // PlayerUI.hitmark(0, Vector3.zero, false, EPlayerHit.NONE);
                                OptimizationVariables.MainPlayer.input.sendRaycast(raycastInfo, ERaycastInfoUsage.Gun);
                            }
                            list.Clear();
                        }
        ...
        else
        {
            ...
            else
            {
                ...
                if (flag4)
                {
                    ...
                    if (flag5)
                    {
                        // DEPRECATED: InteractableDoorHinge removed
                        /*
