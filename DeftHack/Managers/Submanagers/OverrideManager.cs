...
{ 
    public Dictionary<OverrideAttribute, OverrideWrapper> Overrides { get { return OverrideManager._overrides; } }
    public void OffHook()
    {
    ...
    public void LoadOverride(MethodInfo method)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                sw.WriteLine(string.Format("{0}         {1}        {2}        {3}/n{4}", ex.Message,  ex.Source, ex.StackTrace, ex.Data.ToString(), method.Name));
            }
        }
    }
